...
DROP TABLE IF EXISTS GARU.PET CASCADE CONSTRAINTS;
...
-- Create Pets
INSERT INTO GARU.PET(PERSONID, PETNAME, DATEOFBIRTH, ISDEAD) VALUES
(1, 'Penny', DATE '2015-01-01', TRUE),
(1, 'Tiny', DATE '2015-08-02', FALSE),
(3, 'Silver Wolf', DATE '2099-01-01', FALSE),
(4, 'Grey Wolf', DATE '2099-08-02', FALSE);
