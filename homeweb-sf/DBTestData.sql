-- Drop tables
DROP TABLE GARU.PERSON CASCADE CONSTRAINTS;
DROP TABLE GARU.BRANCH CASCADE CONSTRAINTS;
DROP TABLE GARU.ADDRESS CASCADE CONSTRAINTS;
DROP TABLE GARU.PHONE CASCADE CONSTRAINTS;
DROP TABLE GARU.PERSONPHONE CASCADE CONSTRAINTS;

-- Drop sequences
DROP SEQUENCE GARU.seqPerson;
DROP SEQUENCE GARU.seqBranch;
DROP SEQUENCE GARU.seqAddress;
DROP SEQUENCE GARU.seqPhone;
