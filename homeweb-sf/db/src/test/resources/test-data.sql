...
-- Insert Pets
INSERT INTO PET VALUES(1, 'Penny', PARSEDATETIME('01-01-2015', 'MM-dd-yyyy'), TRUE);
INSERT INTO PET VALUES(1, 'Tiny', PARSEDATETIME('08-02-2015', 'MM-dd-yyyy'), FALSE);
INSERT INTO PET VALUES(3, 'Silver Wolf', PARSEDATETIME('01-01-2099', 'MM-dd-yyyy'), FALSE);
INSERT INTO PET VALUES(4, 'Grey Wolf', PARSEDATETIME('08-02-2099', 'MM-dd-yyyy'), FALSE);

-- Insert Appointments
INSERT INTO APPOINTMENT VALUES(1, 1, PARSEDATETIME('01-01-2015 02:00', 'MM-dd-yyyy hh:mm'));
INSERT INTO APPOINTMENT VALUES(1, 1, PARSEDATETIME('01-02-2015 02:00', 'MM-dd-yyyy hh:mm'));
INSERT INTO APPOINTMENT VALUES(1, 1, PARSEDATETIME('01-03-2015 02:00', 'MM-dd-yyyy hh:mm'));
INSERT INTO APPOINTMENT VALUES(1, 1, PARSEDATETIME('01-04-2015 02:00', 'MM-dd-yyyy hh:mm'));
INSERT INTO APPOINTMENT VALUES(1, 1, PARSEDATETIME('01-05-2015 02:00', 'MM-dd-yyyy hh:mm'));

INSERT INTO APPOINTMENT VALUES(2, 1, PARSEDATETIME('02-01-2015 02:00', 'MM-dd-yyyy hh:mm'));
INSERT INTO APPOINTMENT VALUES(2, 1, PARSEDATETIME('02-02-2015 02:00', 'MM-dd-yyyy hh:mm'));
INSERT INTO APPOINTMENT VALUES(2, 1, PARSEDATETIME('02-03-2015 02:00', 'MM-dd-yyyy hh:mm'));
INSERT INTO APPOINTMENT VALUES(2, 1, PARSEDATETIME('02-04-2015 02:00', 'MM-dd-yyyy hh:mm'));
INSERT INTO APPOINTMENT VALUES(2, 1, PARSEDATETIME('02-05-2015 02:00', 'MM-dd-yyyy hh:mm'));
